...
//     return (
//         <div className="timetable-container">
//             <h2>Timetable for Faculty ID: {facultyId}</h2> {/* Display facultyId */}
//             <table className="timetable-table">
//                 <thead>
//                     <tr>
//                         <th>Day/Time</th>
...
import 'jspdf-autotable'; // Import the plugin for auto tables
                        ...
                        <tr key={day}>
                            ...
                            {timeSlots.map((slot, cellIndex) => {
                                ...
                                const cellText = entry 
                                    ? entry.subject_name === "EMPTY" 
                                        ? "-" 
                                        : `${entry.subject_name} (Room ${entry.classroom_id})`
                                    : "-";
                                return <td key={cellIndex} className={cellText === '-' ? 'empty-cell' : ''}>{cellText}</td>;
                            })}
                        </tr>
                    ))}
                </tbody>
