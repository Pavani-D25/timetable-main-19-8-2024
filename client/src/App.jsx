...
import TimetableDisplayView from "./components/TimetableDisplayView"; // Import TimetableDisplayView component
    ...
    <Router>
      <div>
        <Routes>
          ...
          <Route path="/timetable-display-view" element={<TimetableDisplayView />} /> 

          {/* Ensure this matches your navigation */}
